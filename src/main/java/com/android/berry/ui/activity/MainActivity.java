package com.android.berry.ui.activity;
...
import com.android.berry.BaseApp;
import com.android.berry.R;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mEngine =  BaseApp.getInstance().getEngine();
                ...
                for (int i = 0; i < mDefaultViews.size(); i++) {
                    ...
                    simpleDraweeView.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            Toast.makeText(BaseApp.getInstance(), "点击了第" + (finalPosition + 1) + "页", Toast.LENGTH_SHORT).show();
                        }
                    });
                }
